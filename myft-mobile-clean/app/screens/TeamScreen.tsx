          ...
          return (
            <TouchableOpacity style={styles.card} onPress={() => navigateToTeam(item.id)}>
              <View style={styles.cardText}>
                ...
                <Text style={styles.meta}>
                  Record: <Text style={styles.metaStrong}>{formatRecord(item.record)}</Text>
                </Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: CARD, padding: 14, borderRadius: 12, marginBottom: 12, flexDirection: 'row', alignItems: 'center' },
  logoContainer: { width: 32, height: 32, borderRadius: 6, marginRight: 15, backgroundColor: NAVY, alignItems: 'center', justifyContent: 'center' },
  ...
  logo: { width: 75, height: 75, backgroundColor: CARD },
});
