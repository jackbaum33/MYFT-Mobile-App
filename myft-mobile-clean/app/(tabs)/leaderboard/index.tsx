...
const STAT_OPTIONS: { key: string; label: string; short: string }[] = [
  ...
  { key: 'shortReceptions',      label: 'Short Receptions',     short: 'rec'   },
  { key: 'mediumReceptions',     label: 'Medium Receptions',    short: 'rec'  },
  { key: 'longReceptions',       label: 'Long Receptions',      short: 'rec'  },
  { key: 'minimalReceptions',    label: 'Minimal Receptions',   short: 'rec'  },
